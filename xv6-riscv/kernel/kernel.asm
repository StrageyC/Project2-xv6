...
getfilenum(int pid)
{
  ...
  struct proc *p;
  // Search for the process with the specified PID.
  for (p = proc; p < &proc[NPROC]; p++) {
    800025b8:	0000f797          	auipc	a5,0xf
    800025bc:	9b878793          	add	a5,a5,-1608 # 80010f70 <proc>
    800025c0:	00014697          	auipc	a3,0x14
    800025c4:	3b068693          	add	a3,a3,944 # 80016970 <tickslock>
    if (p->pid == pid) {
    800025c8:	5b98                	lw	a4,48(a5)
    800025ca:	00a70a63          	beq	a4,a0,800025de <getfilenum+0x2c>
  for (p = proc; p < &proc[NPROC]; p++) {
    800025ce:	16878793          	add	a5,a5,360
    800025d2:	fed79be3          	bne	a5,a3,800025c8 <getfilenum+0x16>
          count++; // Increment the count for each open file.
      }
      return count; // Return the count of open files.
    }
  }
  return -1; // Error: Process with the specified PID not found.
    800025d6:	557d                	li	a0,-1
}
    800025d8:	6422                	ld	s0,8(sp)
    800025da:	0141                	add	sp,sp,16
    800025dc:	8082                	ret
    800025de:	0d078713          	add	a4,a5,208
    800025e2:	15078793          	add	a5,a5,336
      int count = 0;
    800025e6:	4501                	li	a0,0
    800025e8:	a029                	j	800025f2 <getfilenum+0x40>
          count++; // Increment the count for each open file.
    800025ea:	2505                	addw	a0,a0,1
      for (int fd = 0; fd < NOFILE; fd++) {
    800025ec:	0721                	add	a4,a4,8
    800025ee:	fef705e3          	beq	a4,a5,800025d8 <getfilenum+0x26>
        if (p->ofile[fd] != 0)
    800025f2:	6314                	ld	a3,0(a4)
    800025f4:	fafd                	bnez	a3,800025ea <getfilenum+0x38>
    800025f6:	bfdd                	j	800025ec <getfilenum+0x3a>
...
sys_uptime(void)
{
    ...
    80002d90:	1000                	add	s0,sp,32
  uint xticks;

  acquire(&tickslock);
    80002d92:	00014517          	auipc	a0,0x14
    80002d96:	bde50513          	add	a0,a0,-1058 # 80016970 <tickslock>
    80002d9a:	ffffe097          	auipc	ra,0xffffe
    80002d9e:	e38080e7          	jalr	-456(ra) # 80000bd2 <acquire>
  xticks = ticks;
    80002da2:	00006497          	auipc	s1,0x6
    80002da6:	b2e4a483          	lw	s1,-1234(s1) # 800088d0 <ticks>
  release(&tickslock);
    80002daa:	00014517          	auipc	a0,0x14
    80002dae:	bc650513          	add	a0,a0,-1082 # 80016970 <tickslock>
    80002db2:	ffffe097          	auipc	ra,0xffffe
    80002db6:	ed4080e7          	jalr	-300(ra) # 80000c86 <release>
  return xticks;
}
    80002dba:	02049513          	sll	a0,s1,0x20
    80002dbe:	9101                	srl	a0,a0,0x20
...
sys_getfilenum(void)
{
  ...
  return getfilenum(pid);
    ...
    80002de8:	7ce080e7          	jalr	1998(ra) # 800025b2 <getfilenum>
}
    ...
    80003948:	0ed7e963          	bltu	a5,a3,80003a3a <readi+0xf4>
{
  ...
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    ...
    800039aa:	ab0080e7          	jalr	-1360(ra) # 80002456 <either_copyout>
    ...
    80003a40:	10d7e863          	bltu	a5,a3,80003b50 <writei+0x112>
{
  ...
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    ...
    80003aa2:	a0e080e7          	jalr	-1522(ra) # 800024ac <either_copyin>
